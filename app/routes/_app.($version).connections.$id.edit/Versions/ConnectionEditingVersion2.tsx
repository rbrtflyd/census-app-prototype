...
export default function ConnectionEdit({ data }: { data: any }) {
  ...
  return (
    <div className="flex flex-col h-full w-full overflow-y-auto relative">
      <div className="flex flex-col w-full h-[120px] bg-subtle border-b border-base px-6 *:max-w-[1100px] *:mx-auto *:w-full justify-center shrink-0">
      ...
      <div className="px-6 -mt-6">
        <div className="flex flex-row max-w-[1100px] mx-auto space-x-6 justify-between">
          <div className=" h-full max-w-[800px] w-full gap-6 flex flex-col">
            <div className="flex flex-col gap-4 p-6 bg-white border border-base rounded-lg">
          ...
          <div className="flex flex-col gap-1 text-sm w-[300px] shrink-0 mt-12">
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                <Text className="font-medium leading-none">Docs</Text>
                <Text className="text-light">
                  Some help text describing what docs are
                </Text>
              </div>
            </div>
          </div>
