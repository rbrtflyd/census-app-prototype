...
function CommandGroup({ className, ...props }: CommandGroupProps) {
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        ' [&_[cmdk-group-heading]]:text-light leading-none overflow-hidden p-1 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-2 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium',
        className
      )}
      {...props}
    />
...
function CommandItem({ className, ...props }: CommandItemProps) {
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "data-[selected=true]:bg-deep data-[selected=true]:text-dark [&_svg:not([class*='text-'])]:text-lighter relative flex cursor-pointer items-center gap-2 rounded px-3 py-1.5 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 h-14 transition-all duration-100",
        className
      )}
      {...props}
    />
