...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'pl-3 pr-5 py-2 leading-none border-r border-base text-left align-middle font-normal text-dark [&:has([role=checkbox])]:pr-0 uppercase text-xs',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      'px-3 py-2 align-middle border-r border-base [&:has([role=checkbox])]:pr-0 leading-none truncate',
      className
    )}
    {...props}
  />
