...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      '[&_tr]:border-b border-base hover:bg-white [&_tr]:hover:bg-white [&_tr]:hover:cursor-default',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'px-4 pb-2 pt-5 text-left align-middle font-medium text-dark [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
